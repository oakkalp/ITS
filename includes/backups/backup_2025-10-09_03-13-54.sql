...
CREATE TABLE `bakiye` (
  ...
  `kurye_id` int(11) DEFAULT NULL,
  `mekan_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_kurye_bakiye` (`kurye_id`),
  UNIQUE KEY `unique_mekan_bakiye` (`mekan_id`),
  CONSTRAINT `bakiye_ibfk_1` FOREIGN KEY (`kurye_id`) REFERENCES `kuryeler` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bakiye_ibfk_2` FOREIGN KEY (`mekan_id`) REFERENCES `mekanlar` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;

-- Tablo verileri: bakiye
INSERT INTO `bakiye` VALUES
('1','1',NULL,'0.00','0.00','2025-10-09 03:11:09'),
('2','3',NULL,'0.00','0.00','2025-10-09 03:11:09'),
('3','2',NULL,'0.00','0.00','2025-10-09 03:11:09'),
('4',NULL,'3','0.00','0.00','2025-10-09 03:11:09'),
('5',NULL,'1','0.00','0.00','2025-10-09 03:11:09'),
('6',NULL,'2','0.00','0.00','2025-10-09 03:11:09');
...
('1',NULL,'admin','$2y$10$7GaJqsakVF5yrDEEY95fbO86FD6/XOZ2zKJ28PkbY.ZU.Gw80cgyu','Sistem Yöneticisi',NULL,NULL,'super_admin','1','{\"endpoint\":\"https://fcm.googleapis.com/fcm/send/da3BMSmgHqI:APA91bHnGW3KP6OgX6AdOZ48k052je516UZgIj9PejZajeKUJMXyz7NhBWvQ_K23eeE0FFLlC4kFkGFSzOd4p_dzJFlXAdDFexL5uwxLuwRZGFcl16g36vhbBGEH5h7CkSMbHrPfg9S_\",\"expirationTime\":null,\"keys\":{\"p256dh\":\"BAyKABCkdnqjJMR-Ov3pzQ1CaZiuMSVE_v955yJxhxsVaaiH_odBvgiLTIjrMdkO20AyXbviEixwz6dD5pjpyXs\",\"auth\":\"8vY0EVmTeDEdXkewfK6X3w\"}}','2025-10-08 21:00:22','2025-10-09 02:42:01'),
...
-- Tablo yapısı: kuryeler
DROP TABLE IF EXISTS `kuryeler`;
CREATE TABLE `kuryeler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kurye_adi` varchar(255) NOT NULL,
  `telefon` varchar(20) DEFAULT NULL,
  `komisyon_orani` decimal(5,2) DEFAULT 0.00,
  `baslangic_bakiyesi` decimal(15,2) DEFAULT 0.00,
  `aktif` tinyint(1) DEFAULT 1,
  `olusturma_tarihi` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_kurye_adi` (`kurye_adi`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;

-- Tablo verileri: kuryeler
INSERT INTO `kuryeler` VALUES
('1','Ahmet Yılmaz','05551234567','5.00','0.00','1','2025-10-09 03:11:09'),
('2','Mehmet Demir','05551234568','4.50','0.00','1','2025-10-09 03:11:09'),
('3','Ali Kaya','05551234569','6.00','0.00','1','2025-10-09 03:11:09');

-- Tablo yapısı: mekanlar
...
CREATE TABLE `mekanlar` (
  ...
  `olusturma_tarihi` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_mekan_adi` (`mekan_adi`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;

-- Tablo verileri: mekanlar
INSERT INTO `mekanlar` VALUES
('1','Merkez Lokanta','Merkez Mah. Atatürk Cad. No:1','15.00','0.00','1','2025-10-09 03:11:09'),
('2','Şehir Restoran','Şehir Mah. Cumhuriyet Cad. No:25','20.00','0.00','1','2025-10-09 03:11:09'),
('3','Hızlı Pizza','Hızlı Mah. Pizza Cad. No:10','12.00','0.00','1','2025-10-09 03:11:09');
...
CREATE TABLE `siparisler` (
  ...
  `tutar` decimal(15,2) NOT NULL,
  `komisyon` decimal(15,2) DEFAULT 0.00,
  `delivery_fee` decimal(15,2) DEFAULT 0.00,
  `tahsilat_durumu` enum('bekliyor','kismi_tahsil','tahsil_edildi') DEFAULT 'bekliyor',
  `tahsilat_tarihi` timestamp NULL DEFAULT NULL,
  `olusturma_tarihi` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_kurye_id` (`kurye_id`),
  KEY `idx_mekan_id` (`mekan_id`),
  KEY `idx_tahsilat_durumu` (`tahsilat_durumu`),
  CONSTRAINT `siparisler_ibfk_1` FOREIGN KEY (`kurye_id`) REFERENCES `kuryeler` (`id`) ON DELETE CASCADE,
  CONSTRAINT `siparisler_ibfk_2` FOREIGN KEY (`mekan_id`) REFERENCES `mekanlar` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;

-- Tablo verileri: siparisler
